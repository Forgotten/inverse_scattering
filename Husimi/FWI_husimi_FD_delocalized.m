...
sigma = 0.01;                            % smoother medium for larger sigma
...
%% Save/load the data
% save(fullfile('..','data',...
%     ['scatter_FD_delocal_order',num2str(order_data),...
%     '_An',num2str(delta_m),'_rn',num2str(rn),'_rni',num2str(rni),'_sigma',num2str(sigma),'_flat',num2str(flat),...
...
% %     ['n_delocal_order',sprintf('-%i',[order_data,order_solver]),'_etai',num2str(alpha_i),'_dNoise',num2str(delta_noise),'_dTol',int2str(-log10(dTol)),...
% %     '_An',num2str(delta_m),'_rn',num2str(rn),'_rni',num2str(rni),'_sigma',num2str(sigma),'_flat',num2str(flat),...
